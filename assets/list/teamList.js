export const teamList = [
    ...
    },
    {
      ...
      desc: `Kao worked in direction and production departments of different movies and she has vast experience in international coordination. She excels in communication and coordination during pre-, in- and post-production, action choreography, practical effect and visual effect. In recent years, she focuses on writing and directing movies and TV series and planning virtual production projects.

      Her credits include On Happiness Road, The Village of No Return, Silence, KANO, Life of Pi, GF*BF, Seediq Bale and others.`,
      awards: [
        // { name: 'award name1' },
        // { name: 'award name2' },
      ]
    },
    {
      ...
      desc: `Xie oversaw more than twenty project developments in movies, short films and TV series. He managed to receive funds from the public sector for various works and qualify for admissions to The Golden Horse Film Project Promotion and Nantes Produire au Sud workshop.

      Xie also participated in multiple international projects and accumulated extensive experience in productions. In recent years, he focuses on the makings of multiple narratives and building the core and structure of a story using development tools.
      `,
      awards: [
        // { name: 'award name1' },
        // { name: 'award name2' },
    ...
    },
    {
      ...
      desc: `Sheng is one of the most versatile and sought-after MV directors in the Chinese community with major credits for A-list Asian artists.

      Sheng’s works show his flowing creativity and wild mannerism, and you can see his different sides in them.
      `,
      awards: [
        // { name: 'award name1' },
        // { name: 'award name2' },
    ...
    },
    {
      ...
      desc: `With years of experience in film productions, Cheng has been promoting the filmmaking of IP works and collaborating with publishers. He’s an agent of more than three hundred IP novels, with many of them being developed into films and dramas. Channeling international markets and crossover projects are Cheng’s strong suits.`,
        awards: [
        // { name: 'award name1' },
        // { name: 'award name2' },
      ]
